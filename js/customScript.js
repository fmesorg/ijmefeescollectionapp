...
var ifAllFilled = function () {
    ...
    if (!isNotBlank("amount") || !isAmountSet("amount")) {
        check = false
        document.getElementById("paymentButtonGroup").style.border = "solid 1px red";
        document.getElementById("paymentButtonGroup").style.borderRadius = ".3rem";
        document.getElementById("customAmount").style.border = "solid 1px red";
    } else {
        document.getElementById("paymentButtonGroup").style.border = "";
        document.getElementById("customAmount").style.border = "";
    }
